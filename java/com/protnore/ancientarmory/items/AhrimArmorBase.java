...
import com.protnore.ancientarmory.objects.items.models.Ahrim_Armor;
...
public class AhrimArmorBase extends ItemArmor implements IHasModel
{
	public AhrimArmorBase(String name, CreativeTabs tab, ArmorMaterial materialIn, EntityEquipmentSlot equipmentSlotIn)
	{
	...
	public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack itemStack, EntityEquipmentSlot armorSlot, ModelBiped _default) 
	{
		if(itemStack!= ItemStack.EMPTY) 
		{
			if(itemStack.getItem() instanceof ItemArmor) 
			{
			    ...
			    Ahrim_Armor model = new Ahrim_Armor ();
