...
import com.protnore.ancientarmory.objects.items.models.Guthan_Boots;
...
public class GuthanBootsBase extends ItemArmor implements IHasModel
{
	public GuthanBootsBase(String name, CreativeTabs tab, ArmorMaterial materialIn, EntityEquipmentSlot equipmentSlotIn)
	{
	...
	public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack itemStack, EntityEquipmentSlot armorSlot, ModelBiped _default) 
	{
		if(itemStack!= ItemStack.EMPTY) 
		{
			if(itemStack.getItem() instanceof ItemArmor) 
			{
				...
				Guthan_Boots model = new Guthan_Boots ();
