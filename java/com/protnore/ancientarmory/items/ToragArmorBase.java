...
import com.protnore.ancientarmory.objects.items.models.Torag_Armor;
...
public class ToragArmorBase extends ItemArmor implements IHasModel
{
	public ToragArmorBase(String name, CreativeTabs tab, ArmorMaterial materialIn, EntityEquipmentSlot equipmentSlotIn)
	{
	...
	public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack itemStack, EntityEquipmentSlot armorSlot, ModelBiped _default) 
	{
		if(itemStack != itemStack.EMPTY) 
		{
			if(itemStack.getItem() instanceof ItemArmor) 
			{
				...
				Torag_Armor model = new Torag_Armor ();
